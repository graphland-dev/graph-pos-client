...
function commaNumber(
  ...
  // to fix decimal 2 places
  inputNumber = Number(inputNumber.toFixed(2));
...
function parse(string: string, separator: string) {
...
function bindWith(separator: string, decimalChar: string) {
