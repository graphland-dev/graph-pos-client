...
export type Get_User_QueriesQuery = {
  __typename?: "Query";
  identity__me?: {
    __typename?: "User";
    _id: string;
...
export type Setup__BrandsQuery = {
  __typename?: "Query";
  setup__brands: {
    __typename?: "BrandsWithPagination";
    meta?: { __typename?: "PagniationMeta"; totalCount: number } | null;
    nodes?: Array<{
      __typename?: "Brand";
      _id: string;
      code: string;
...
export type Setup__CreateBrandMutation = {
  __typename?: "Mutation";
  setup__createBrand: { __typename?: "CommonMutationResponse"; _id: string };
};
...
export type Setup__UpdateBrandMutation = {
  __typename?: "Mutation";
  setup__updateBrand: boolean;
};
...
export type Setup__RemoveBrandMutation = {
  __typename?: "Mutation";
  setup__removeBrand: boolean;
};
...
export type Identity__LoginMutation = {
  __typename?: "Mutation";
  identity__login: { __typename?: "LoginResponseDto"; accessToken: string };
};
...
export const Get_User_QueriesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GET_USER_QUERIES" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "identity__me" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "identity__myPermissions" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "tenant" },
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "identity__myTenants" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "businessPhoneNumber" },
                      },
                      {
                        kind: "Field",
  ...
  Get_User_QueriesQuery,
  Get_User_QueriesQueryVariables
>;
...
} as unknown as DocumentNode<Setup__BrandsQuery, Setup__BrandsQueryVariables>;
export const Setup__CreateBrandDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "Setup__createBrand" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
  ...
  Setup__CreateBrandMutation,
  Setup__CreateBrandMutationVariables
>;
export const Setup__UpdateBrandDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "Setup__updateBrand" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CommonFindDocumentDto" },
            },
          },
        },
        {
  ...
  Setup__UpdateBrandMutation,
  Setup__UpdateBrandMutationVariables
>;
export const Setup__RemoveBrandDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "Setup__removeBrand" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  Setup__RemoveBrandMutation,
  Setup__RemoveBrandMutationVariables
>;
export const Identity__LoginDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "Identity__login" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  Identity__LoginMutation,
  Identity__LoginMutationVariables
>;
export const Identity__MyTenantsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  Identity__MyTenantsQuery,
  Identity__MyTenantsQueryVariables
>;
